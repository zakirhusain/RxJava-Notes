...
public class CompositeDisposableActivity extends AppCompatActivity {
    ...
    private static final String TAG = "CompositeDisposableActi";
    ...
    private DisposableObserver<String> getAnimalsAllCapsObserver() {
        return new DisposableObserver<String>() {
            ...
            public void onNext(String s) {
                Log.i(TAG, "onNext: All Caps " + s);
            }

            @Override
            public void onError(Throwable e) {
                Log.i(TAG, "onError: All Caps " + e.getMessage());
            }

            @Override
            public void onComplete() {
                Log.i(TAG, "onComplete: All Caps " + "All items are emitted successfully");
            }
        };
    }
